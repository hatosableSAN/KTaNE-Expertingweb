    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
          ...
          //}else {
            ...
            //for(int i=0;i<list.size();i++){
                ...
                out.println("</tr>");
                out.println("</table>");
                out.print("<input type='submit'/ name='student_delete' value='削除' class='btn' style='color:red;position:absolute; right:40px; bottom: 50px; font-size: 20px;'>");
                out.print("<input type='hidden'/ name='delete_hidden' value=");
                out.print(student.getStudent_id());
                out.print(">");
                out.println("</form>");
            out.println("<form action='./ManageStudent' method='post'>");
            out.println("<input type='submit' value='キャンセル' class='button_grey' style='position:absolute; left:40px; bottom: 50px; font-size: 20px;'></form>");
            out.println("</body>");
