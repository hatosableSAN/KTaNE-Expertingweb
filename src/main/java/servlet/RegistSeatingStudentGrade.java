...
@WebServlet("/RegistSeatingStudentGrade")

// HttpServletを継承することで、このクラスはServletとして、働くことができる
public class RegistSeatingStudentGrade extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (LoginChecker.notLogin(session)) {
            ...
            List<StudentSeatingArr> StudentList = (List<StudentSeatingArr>) session
                    .getAttribute("StudentSeatingArrList");// 生徒全員のリスト所得
