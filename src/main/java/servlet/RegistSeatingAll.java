...
public class RegistSeatingAll extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (LoginChecker.notLogin(session)) {
            ...
            String tourl = "/WEB-INF/seating/registSeatingfail.jsp";
            // 座席配置情報をセッションから取得
            ...
            if (setseatingArrangements == null) {
                ...
                tourl = "/WEB-INF/seating/registSeatingfail.jsp";
            } else {
                ...
                // 座席を登録
                boolean result = seatingService.registStudentSeatingArr(studentSeatingArrList);
                if (!result) {
                    System.out.println("座席（生徒）登録失敗");
                    tourl = "/WEB-INF/seating/registSeatingfail.jsp";
                } else {
                    System.out.println("座席（生徒）登録完了");
                    tourl = "/WEB-INF/seating/registSeatingcomplete.jsp";
