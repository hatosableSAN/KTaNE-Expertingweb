...
public class UpdateStudent extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (LoginChecker.notLogin(session)) {
            ...
            // RequestDispatcher dispatcher =
            // request.getRequestDispatcher("/WEB-INF/student/updateStudent.jsp");
            // forwardはrequestオブジェクトを引数として、次のページに渡すことができる
            // dispatcher.forward(request, response);
            request.setCharacterEncoding("UTF-8");
             ...
             * out.
             * println("<tr><th>番号　　　　　　　　　　　　　</th><th>名前　　　　　　　　　　　　　　　　　</th><th>性別　　　　　　　　</th><th>登録者　　　　　　　　　　　　　</th><th>　　　　　</th><th>　　　　　</th></tr>"
             * );
             * out.print("<tr><td>");
             ...
             * out.print(student.getStudent_id());
             * out.
             * print("></td><td><input type='text' name='stu_name' maxlength='20' minlength='1' pattern='"
             * );
             ...
             * out.print("></td></table>");
             * out.
             * println("<div class='center'><input type='submit' name='student_update' value='変更' class='btn' style='font-size:20px;'></div>"
             * );
