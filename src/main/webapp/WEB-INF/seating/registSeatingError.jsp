  ...
  <body>
    ...
    <div class="center">児童・生徒の席を以下に確定しました。期間・席名を入力し、登録してください。</div><br>
      <form>
        ...
        <Br>
        席名：<input type="text" value="<%=seatingArrangements.getName()%>"name="seatname" placeholder="(0~20文字)" maxlength="20" minlength="1" pattern="[ぁ-んァ-ヶｦ-ﾟ一-龠a-zA-Z0-9\s\-\u30FC]+"/><br>
        ...
        <div id="modal-content">
            ...
            <p><input type="submit" formaction="./RegistSeatingStudent" formmethod="POST" value="座席を確定する" class="btn" align="center"style="position:absolute;bottom:10px;right:20px;" /></p>
            <%-- TODO:座席を確定するを押したら2重に送信されないようにする --%>

            <p><a id="modal-close" class="button-link"><button align="center" style="width:100px;">閉じる</button></a></p>
        </div>
</form>
      <br />
